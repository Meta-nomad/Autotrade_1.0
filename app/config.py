...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            daily_stop_pct=_float("DAILY_STOP_PCT", 6.0),
            monthly_stop_pct=_float("MONTHLY_STOP_PCT", 18.0),
...
def account_configs(settings: Settings) -> tuple[AccountConfig, ...]:
    return (
        AccountConfig(
            ...
            risk_pct=settings.control_risk_pct,
        ...
        AccountConfig(
            name="ORDER_FLOW_TURBO",
            strategy="order_flow",
            starting_balance=settings.paper_balance,
            risk_pct=settings.turbo_risk_pct,
            max_leverage=settings.turbo_max_leverage,
        ),
    )
